...
Some ideas:
- extend one task of A5 to have experiments that more carefully analyze and compare different models at a task for one of the ml tasks (classification, regression, clustering) and visualize and summarize
...
- summarize the what you learned from a speaker
